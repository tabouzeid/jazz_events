...
export default function Carousel() {
    ...
    return (<FadeIn>
        <div className="mx-auto col-7 mt-1">
            <div id="carouselExampleCaptions" className="carousel cycle carousel-fade" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none d-md-block text-dark mb-auto" style={style}>
                    ...
                    <div className="carousel-item mx-auto">
                        ...
                        <div className="carousel-caption d-none d-md-block text-dark" style={style}>
